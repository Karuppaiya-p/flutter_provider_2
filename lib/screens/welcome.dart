...
class _WelcomeState extends State<Welcome> with TickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(padding: EdgeInsets.all(40.0),
      child: Column(children: <Widget>[
        Text("Welcome",
        style: GoogleFonts.lakkiReddy(fontSize:40.0,textStyle:TextStyle(color:Colors.black)),),
         Text(providerData.firstName,
        style: GoogleFonts.lakkiReddy(fontSize:40.0,textStyle:TextStyle(color:Colors.black)),),
         Text(providerData.lastName,
        style: GoogleFonts.lakkiReddy(fontSize:40.0,textStyle:TextStyle(color:Colors.black)),)
      ],),),
    );
  }
